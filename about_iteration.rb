...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Takes an array and produces a single return result
  end
  ...
  # in the event that there is as file with the same name, OR to maybe
  # be able to iterate over every line in the file

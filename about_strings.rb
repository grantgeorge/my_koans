...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Because it reduces the amount of variables needed to be declared
    # and you can still revert i.e. in this example, there is still in
    # tact and we can build the original string by revertin gthe shovel
    # operation
  end
